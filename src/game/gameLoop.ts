...
import { obj_cubeStack, obj_cubeStack_boxSlot, obj_cubeStack_pillySlot, obj_oldScene, obj_oldScene_box1Slot, obj_oldScene_box2Slot, obj_oldScene_box3Slot, obj_oldScene_clubSlot, type SceneHandle } from "../gamedata/objects.gen.ts";
...
export function processFrame() {
	...
	drawScene(obj_cubeStack, {
		[obj_cubeStack_boxSlot]: IDENTITY.rotate(rotation, rotation / 3, rotation / 3),
		[obj_cubeStack_pillySlot]: IDENTITY.translate(0, 0.5 * (Math.sin(time * 20) * 0.5 + 0.5), 0),
	});
